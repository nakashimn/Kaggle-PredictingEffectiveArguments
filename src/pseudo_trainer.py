...
from components.datamodule import FpDatasetPseudo, FpDataModulePseudo
from components.models import FpModelPseudo
...
if __name__=="__main__":
    ...
    df_train_and_pseudo = data_preprocessor.train_dataset()
    df_train = df_train_and_pseudo.loc[~df_train_and_pseudo["pseudo"]].reset_index(drop=True)
    df_pseudo = df_train_and_pseudo.loc[df_train_and_pseudo["pseudo"]].reset_index(drop=True)
